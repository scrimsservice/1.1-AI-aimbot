...
def setup():
    ...
    print("[INFO] In-game X and Y axis sensitivity MUST be the same")
    def prompt(str):
        valid_input = False
        while not valid_input:
            try:
                ...
                print("[!] Invalid Input. Make sure to enter only the number (Example: 6.9)")
        return number
